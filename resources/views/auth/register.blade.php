        ...
        <div class="md:w-6/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register.store') }}" method="post">
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        name="name" id="name" placeholder="Tu nombre de usuario"
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        name="username" id="username" placeholder="Tu username"
                ...
                <div class="mb-5">
                    ...
                    <input type="email"
                        name="email" id="email" placeholder="Tu email de registro"
                ...
                <div class="mb-5">
                    ...
                    <input type="password"
                        name="password_confirmation" id="password_confirmation" placeholder="Repetir password de registro"
